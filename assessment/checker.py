"""
# Name:           check_answer_api/checker.py
# Description:
...
'''
def check(correct_answer, user_answer, topic="Unknown", answer_type="Expression", switchable=False, check_step=False):
	...
	important_step = None
	if check_step and answer_type == "Prove":
